...
begin:"@"+e.IDENT_RE,relevance:0};return{name:"C#",aliases:["cs","c#", "c_sharp"],
...
;hljs.registerLanguage("csharp",e)})();/*! `cyberchef` grammar compiled for Highlight.js 11.11.1 */
(()=>{var e=(()=>{"use strict";return e=>({name:"CyberChef Recipe",
disableAutodetect:!0,contains:[{begin:[/\b[A-Za-z0-9_/]+/,/\(/],beginScope:{
1:"title",2:"punctuation"},relevance:1},{className:"string",begin:/'/,end:/'/,
...
begin:"(string|char|byte|intptr|int32|int|long|bool|decimal|single|double|DateTime|xml|array|hashtable|void|ref)",
...
;hljs.registerLanguage("powershell",e)})();/*! `x86asm` grammar compiled for Highlight.js 11.11.1 */
